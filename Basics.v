...
Theorem plus_id_exercise : forall n m o : nat,
  n = m -> m = o -> n + m = m + o.
Proof. intros n m o. intros H. intros H1. rewrite H. rewrite H1. reflexivity. Qed.
...
Theorem mult_S_1 : forall n m : nat,
  ...
  m * (1 + n) = m * m.
Proof.
  Proof. intros m n. intros H1. rewrite H1. reflexivity. Qed.
...
- (*b=true*) simpl. intros. rewrite H. reflexivity. 
- (*b=false*) simpl. intros. inversion H.
Qed.
...
(*x=true*) rewrite x. rewrite x. reflexivity.
(*x=false*) rewrite x. rewrite x. reflexivity.
 Qed.
...
(*b=true*) destruct c. 
            (*c=true*)intros H1. reflexivity.
            (*c=false*)intros H2. inversion H2.
(*b=false*) destruct c. 
            (*c=true*)intros H3. inversion H3.
            (*c=false*)intros H4. reflexivity.
Qed.
